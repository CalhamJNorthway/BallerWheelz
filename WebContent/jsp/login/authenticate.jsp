...
<%
    ...
    String sql = "SELECT * FROM Baller WHERE email = ";
	...
	try ( Connection con = DriverManager.getConnection(url, uid, pw);){
		...
		String name = null;
		String address = null;
		while (rst.next()) { id = rst.getInt("id"); recievedEmail = rst.getString("email"); recievedPassword = rst.getString("password"); name= rst.getString("name"); address = rst.getString("address");}
		User loggedInUser = new User(id, name, recievedEmail, recievedPassword, address);
